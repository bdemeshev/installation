...
```
Инструкция: 
1. Зайти на https://github.com/kthohr/BMR и на https://www.kthohr.com/bmr.html и посмтреть требования для установки (пакеты и версии). Установить или обновить то, что нужно.
```{r eval = FALSE}
